...
import static io.trino.jdbc.$internal.guava.base.Verify.verify;
import static io.trino.jdbc.$internal.guava.collect.Lists.newArrayList;
import static io.trino.jdbc.$internal.client.ClientTypeSignature.VARCHAR_UNBOUNDED_LENGTH;
